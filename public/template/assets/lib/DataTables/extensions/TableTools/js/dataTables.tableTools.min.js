    ...
    var r = function (n) {
        ...
        h.Client.prototype = {
            ...
            receiveEvent: function (a, b) {
                ...
                e; d++) {
                    ...
                    if ("function" == typeof f)f(this, b); else if ("object" == typeof f && 2 == f.length)f[0][f[1]](this, b); else if ("string" == typeof f)l[f](this, b)
                }
            }
        };
        ...
        g.prototype = {
            fnGetSelected: function (a) {
                ...
                for (var a = g._aInstances, b = 0, c = a.length; b < c; b++)if (this.dom.table == a[b].s.dt.nTable)return a[b].s
                ...
                if (this.s.master) {
                    ...
                    f(b.nTBody).on("click.DTTT_Select", "tr", function (c) {
                        ...
                        if (this.parentNode == b.nTBody && b.oInstance.fnGetData(this) !== null) {
                            if (d.type == "os")if (c.ctrlKey || c.metaKey)a.fnIsSelected(this) ? a._fnRowDeselect(this, c) : a._fnRowSelect(this, c); else if (c.shiftKey) {
                                var g = a.s.dt.aiDisplay.slice(), m = f.inArray(d.lastRow, g), i = f.inArray(e, g);
                                if (a.fnGetSelected().length ===
                                    0 || m === -1)g.splice(f.inArray(e, g) + 1, g.length); else {
                                    if (m > i)var j = i, i = m, m = j;
                            ...
                            } else if (a.fnIsSelected(this) && a.fnGetSelected().length === 1)a._fnRowDeselect(this, c); else {
                                a.fnSelectNone();
                                a._fnRowSelect(this, c)
                            } else if (a.fnIsSelected(this))a._fnRowDeselect(this, c); else if (d.type == "single") {
                                a.fnSelectNone();
                                a._fnRowSelect(this, c)
                ...
                for (e in d)if ("i" != e && "t" != e && 1 == e.length)for (var g = 0, h = d[e].length; g < h; g++)this.dom.print.hidden.push({
                    node: d[e][g],
                    display: "block"
        ...
        g.fnGetInstance = function (a) {
            ...
            for (var b = 0, c = g._aInstances.length; b < c; b++)if (g._aInstances[b].s.master && g._aInstances[b].dom.table == a)return g._aInstances[b];
            return null
        };
        ...
        g.BUTTONS = {
            csv: f.extend({}, g.buttonBase, {
                sAction: "flash_save", sButtonClass: "DTTT_button_csv",
        ...
        g.classes = {
            ...
            print: {
                body: "DTTT_Print", info: "DTTT_print_info",
