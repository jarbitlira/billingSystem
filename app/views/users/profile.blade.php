...
<div class="user_profile">
    ...
    <div class="tabbable tabs-right">
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#profile_general_pane" class="tab-default">General Info</a>
            </li>
...
{{--                            {{ Form::password('password', ['class'=>'form-control', 'id'=>'profile_password']) }}--}}
            ...
            <div id="profile_other_pane" class="tab-pane">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input type="checkbox" class="bs_switch" data-on-color="success" data-on-text="Yes"
                               data-off-text="No">
                    </div>
                </div>
            </div>
